...
public class CloudAppTest {
 ...
 @SneakyThrows
 @Test
 public void excelTest(HttpServletRequest request, HttpServletResponse response,String codedFileName ){
     //数据
    ...
    //还需要设置一个子表头key的集合
     ...
     entityList.add(e4);
     codedFileName = "Test.xlsx";
     Workbook workbook = ExcelExportUtil.exportExcel(new ExportParams(codedFileName, "sheetName"),entityList,dataList);
